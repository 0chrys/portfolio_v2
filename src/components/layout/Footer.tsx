      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link
              href="/"
              className="text-2xl font-bold tracking-tighter text-foreground mb-4 inline-block"
            >
              CK<span className="text-accent">Labs</span>
            </Link>
            <p className="text-muted text-sm leading-relaxed max-w-sm mb-6">
              Expertise hybride en cybersécurité et développement Fullstack.
              Protéger, bâtir et innover pour des écosystèmes numériques
              résilients.
            </p>
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center text-muted hover:text-accent hover:border-accent transition-all duration-300"
                aria-label="GitHub"
              >
                <svg
                  className="w-5 h-5"
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted">
            &copy; {currentYear} CKLabs Portfolio. Tous droits réservés.
          </p>
